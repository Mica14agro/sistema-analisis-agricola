...
# Importar el módulo de Earth Engine si está disponible
if ee_disponible:
    from earth_engine_integration import (
        inicializar_earth_engine, 
        crear_boton_analisis_cultivos,
...
4. Analizar los cultivos históricos de los campos (requiere Google Earth Engine)
""")
